 ...
 * Author: Daniel Yan
 * Date: 5/12/2019
 * Purpose: Kernel from ThreadOS modified
 */
import java.util.*;
...
/***********************Part 1 Kernel modification *************************/
      /*
       * Gets the current thread id and lets it sleep in the waitQueue
       * until the condition is satisfied.
       * Condition is the current threadID
       */
	    case WAIT:
         //Use above TCB
      ...
      /*
       * Gets the current thread id of the parent.
       * Looks in the waitQueue and wakes up the thread when
       * the condition is satisfied.
       * Scheduler will delete the current thread
       */
      case EXIT:
            //Use above TCB
            myTcb= scheduler.getMyTcb();
...
/***********************End of Part 1 Kernel modification *******************/
...
///////////////////////////////////////////////////////////////////////////////////////
	    ...
	    case RAWREAD: // read a block of data from disk
            ...
            //let CPU be relinquished to another thread that's ready
