...
// Modified Kernel for P5 with FileSystem calls
import java.util.*;
         ...
         case INTERRUPT_SOFTWARE: // System calls
            switch( cmd ) {
               ...
               case CLOSE:
                    ...
                    {
                      FileTableEntry ftEnt = myTcb.getFtEnt(param);
                      if(ftEnt == null || fs.close(ftEnt) == ERROR)
                          return ERROR;
               ...
               case SEEK:
                  ...
                  return ERROR;
               case FORMAT:
                  return (fs.format(param) == OK) ? OK : ERROR;
               case DELETE:
                  return (fs.delete((String) args) == OK) ? OK : ERROR;
            }
            return ERROR;
